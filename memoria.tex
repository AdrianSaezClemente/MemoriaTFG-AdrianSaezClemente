...
\begin{itemize}
  ...
  \item {\bfseries \textit{Eliminar comentario en hilo de alumno}}: Las entradas de un hilo dan la posibilidad de eliminar comentarios sobre esa entrada 
  al pulsar el bot\'on \texttt{Eliminar comentario} que mediante el evento \textit{onClick} llama a la funci\'on \textit{JavaScript} 
  ...
  y resta la puntuaci\'on del objeto \texttt{Valoracion} perteneciente al alumno que elimina el comentario y actualiza su nivel.
  ...
  \item {\bfseries \textit{Valoraci\'on positiva y negativa de una entrada}}: 
