...
\begin{itemize}
  ...
  fichero \texttt{presentacionprof.js}. Esta funci\'on 
  \item {\bfseries \textit{Eliminar hilo en presentaci\'on de tutor}}:
  \item {\bfseries \textit{Puntuaciones}}:
  \item {\bfseries \textit{Desconectar}}: 
\end{itemize}
