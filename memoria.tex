...
\label{sec:buscar}
El documento HTML mostrado en la figura~\ref{fig:buscar} es el contenedor de la p\'agina de b\'usqueda avanzada de entradas. 
...
\label{sec:ranking}
El documento HTML mostrado en la figura~\ref{fig:ranking} es el contenedor de la p\'agina de ranking de un determinado hilo. 
La p\'agina es servida tras una previa petici\'on GET del cliente mediante el correspondiente recurso \footnote{Url correspondiente a la p\'agina de 
