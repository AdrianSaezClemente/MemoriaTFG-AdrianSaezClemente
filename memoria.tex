...
A esta p\'agina puede entrar cualquier usuario que pretenda crearse un perfil en la aplicaci\'on o quiera acceder a su perfil una vez creado.
...
\texttt{presentacionalumno.html} que crea el documento HTML de la respuesta.
...
\texttt{presentacionprofesor.html} que crea el documento HTML de la respuesta.
...
En la figura~\ref{fig:hilos}
En la figura~\ref{fig:hiloalumno}
\begin{figure}
  \centering
