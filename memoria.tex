...
Las siguientes secciones declaran el objetivo general y los objetivos espec\'ificos del trabajo de fin de grado realizado.

\section{Objetivo general}
\label{sec:objetivo-general}
El objetivo principal del proyecto es el desarrollo de una aplicaci\'on educativa que englobe multitud de temas y que los usuarios interactuen para una 
correcta formaci\'on y un \'optimo aprendizaje.
